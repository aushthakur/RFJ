  ...
  const heroSlides = [
    {
      ...
      subtitle: 'RITUALS FINE JEWELLERY'
    },
    {
      id: 2,
        ...
        {heroSlides.map((slide, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-start justify-center px-12 lg:px-24">
              {/* Logo */}
              <div className="mb-6">
                <div className="w-20 h-20 rounded-full border-4 border-amber-600 flex items-center justify-center bg-transparent">
                  <span className="text-5xl font-serif text-amber-600">{slide.logo}</span>
                </div>
              </div>
              ...
              <p className="text-xl md:text-2xl text-white tracking-widest font-light uppercase">
                {slide.subtitle}
              </p>
            </div>
          </div>
